...
#                      this chapter.
#       PokerHand.py : An incomplete implementation of a class that represents 
...
#
# Question 3
# 3. Add methods to PokerHand.py named has_pair, has_twopair, etc. that return 
# True or False according to whether or not the hand meets the relevant 
# criteria. Your code should work correctly for "hands" that contain any number 
# of cards (although 5 and 7 are the most common sizes).
#
...
# next step is to estimate the probabilities of the various hands. Write a 
# function in PokerHand.py that shuffles a deck of cards, divides it into hands,
...
# values at http://en.wikipedia.org/wiki/Hand_rankings.
# 